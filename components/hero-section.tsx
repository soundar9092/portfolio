...
export function HeroSection() {
  const handleGetInTouch = () => {
    window.location.href = "mailto:Talktosoundar@gmail.com"
  }
      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        <div className="space-y-6">
          <h1 className="text-[42px] leading-[50px] md:text-[72px] font-bold md:leading-[85px]">
            I'm <span className="bg-[#FF6B7A] text-white px-3 py-1 inline-block">Soundar</span>, Web Developer from{" "}
            <span className="bg-[#2F81F7] text-white px-3 py-1 inline-block">Tamilnadu</span>
          </h1>

          <p className="text-[#393939] text-[16px] md:text-[18px] font-medium leading-[28px] md:leading-[30px] max-w-xl">
            Full Stack Developer with 3.5+ years of experience. Specializing in web design, backend development, and
            e-commerce solutions. Currently working at Vinsinfo Pvt Ltd.
          </p>
