  ...
  const services = [
    {
      title: "Web Design",
      description:
        "Creating responsive and visually appealing websites that provide excellent user experience and engage your audience effectively.",
      image: "/images/web-design.svg",
    },
    {
      title: "Backend Development",
      description:
        "Building robust and scalable backend systems with modern technologies to power your applications efficiently.",
      image: "/images/ui-ux-design.svg",
    },
    {
      title: "Ecommerce Solutions",
      description:
        "Developing complete ecommerce platforms with payment integration, inventory management, and seamless shopping experiences.",
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="text-[#393939] text-base md:text-lg font-medium leading-relaxed md:leading-[30px] max-w-2xl mx-auto">
              Specializing in web design, backend development, and ecommerce solutions with 3.5+ years of experience in
